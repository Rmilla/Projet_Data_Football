    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games', to='django_app_foot.competition')),
            ],
        ),
        migrations.CreateModel(
            name='ClubGame',
            fields=[
                ...
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clubGames', to='django_app_foot.club')),
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clubGames', to='django_app_foot.game')),
            ],
        ),
        migrations.CreateModel(
            name='GameEvent',
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games', to='django_app_foot.game')),
                ('player', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='players', to='django_app_foot.player')),
            ],
        ),
        migrations.CreateModel(
            name='Appearance',
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appearences', to='django_app_foot.game')),
                ('player', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='appearances', to='django_app_foot.player')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='playerValuations', to='django_app_foot.player')),
            ],
        ),
    ]
